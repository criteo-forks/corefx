...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes128Cfb1(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes128Cfb8(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes128Cfb128(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes192Cfb1(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes192Cfb8(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes192Cfb128(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes256Cfb1(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes256Cfb8(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpAes256Cfb128(void);
...
*/
extern "C" const EVP_CIPHER* CryptoNative_EvpDes3Cfb(void);
